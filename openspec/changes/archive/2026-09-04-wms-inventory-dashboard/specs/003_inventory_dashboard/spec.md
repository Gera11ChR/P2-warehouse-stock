...
The system SHALL provide create, read, update, and delete operations for materials, with created, modified, and deleted materials persisted atomically.
...
The system SHALL provide a seed routine that loads 53 general materials and 5 fiber-optic materials across the supported units.

#### Scenario: Seed loads full data set
- **WHEN** the seed routine is executed against an empty database
- **THEN** 53 general materials and 5 fiber-optic materials are created with valid units
